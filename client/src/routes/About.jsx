      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:gap-10">
          ...
          <div className="flex flex-col gap-8 lg:w-3/5">
            ...
            <a
              href="#"
              className="w-36 rounded-md bg-[#B58C13] px-6 py-3 text-center font-semibold text-white"
            >
              Learn More
            </a>
            ...
            <div className="grid gap-8 md:grid-cols-2 md:gap-4">
              <div className="flex flex-col gap-4 rounded-md border border-solid bg-gray-100 p-6 md:p-4">
                <p className="text-sm">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, fuga in, hic veniam accusamus facere atque quidem dolorem asperiores vel sint nisi sit incidunt autem? Quos laborum enim quod iure in odit inventore cumque, amet eius delectus, corporis obcaecati
                </p>
